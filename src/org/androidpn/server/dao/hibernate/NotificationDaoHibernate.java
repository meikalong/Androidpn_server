...
public class NotificationDaoHibernate extends HibernateDaoSupport implements NotificationDao {
	...
	public NotificationMO queryNotificationById(Long id) {
		NotificationMO notificationMO = (NotificationMO) getHibernateTemplate().get(NotificationMO.class, id);
	...
	public List<NotificationMO> queryNotificationByUserName(String userName, String messageId) {
		...
		return getHibernateTemplate().find(
				"from NotificationMO n where n.username=? and n.messageId=? order by n.createTime desc", params);
	}
